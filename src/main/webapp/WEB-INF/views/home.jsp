          ...
          <div class="frame">
            ...
            <div ng-app ng-init="checked = false">
                  ...
                  <div class="btn-animate">
                    <a href="./crearDonante" style="text-decoration: none;color: #ffffff" class="btn-signin">Entrar</a>
                  </div>
                                </form>
                  ...
                  <a ng-click="checked = !checked" class="btn-signup">Registrarse</a>
                    ...
                    <div  class="success">
                      <img src="https://i.ibb.co/jTwjX9w/emoticon-square-smiling-face-with-closed-eyes.png" width="80" style="margin-top: 40%;">
